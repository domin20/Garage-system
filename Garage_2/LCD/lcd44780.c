...
/*
	static const uint8_t tab1[] PROGMEM = {0,0,14,1,15,17,15,2};		// litera "π"
	static const uint8_t tab2[] PROGMEM = {4,4,4,6,12,4,31,0};			// litera "≥"
	static const uint8_t tab3[] PROGMEM = {16,16,18,20,24,16,31,0};		// litera "duøe ≥"
	static const uint8_t tab4[] PROGMEM = {2,4,31,2,4,8,31,0};			// litera "ü"
	static const uint8_t tab5[] PROGMEM = {0,0,14,17,31,16,14,4};		// litera "Í"
	static const uint8_t tab6[] PROGMEM = {2,4,14,16,14,1,30,0};		// litera "ú"
	static const uint8_t tab7[] PROGMEM = {0,4,31,2,4,8,31,0};			// litera "ø"
	static const uint8_t tab8[] PROGMEM = {2,4,14,17,17,17,14,0};		// litera "Û"

	lcd_defchar_P(0x80, tab1);		// "π"
	lcd_defchar_P(0x81, tab2);		// "≥"
	lcd_defchar_P(0x82, tab3);		// duze "≥"
	lcd_defchar_P(0x83, tab4);		// "ü"
	lcd_defchar_P(0x84, tab5);		// "Í"
	lcd_defchar_P(0x85, tab6);		// "ú"
	lcd_defchar_P(0x86, tab7);		// "ø"
	lcd_defchar_P(0x87, tab8);		// "Û"
*/
	// kasowanie ekranu
	lcd_cls();
}
